...
public:
  ...
  virtual MediaImportHandlerConstPtr GetImportHandler(const MediaType& mediaType) const;
  ...
  */
  bool AddSource(const std::string& sourceID, const std::string& friendlyName, const std::string& iconUrl = "", const MediaTypes& mediaTypes = MediaTypes());
  ...
  * \param mediaTypes Media types supported by the source
  */
  bool AddSourceSync(const std::string& sourceID, const std::string& friendlyName, const std::string& iconUrl = "", const MediaTypes& mediaTypes = MediaTypes());
   ...
   */
  bool AddSelectiveImport(const std::string &sourceID, const std::string &path, const std::string& parentPath, const GroupedMediaTypes &mediaTypes);
...
private:
  ...
  bool AddSourceInternal(const std::string& sourceID, const std::string& friendlyName, const std::string& iconUrl, const MediaTypes& mediaTypes, bool synchronous);
  bool AddSource(const CMediaImportSource &source);
  bool FindSource(const std::string &sourceID, CMediaImportSource &source) const;

  bool AddImport(const std::string &sourceID, const std::string &path, const std::string& parentPath, const GroupedMediaTypes &mediaTypes, bool recursive);
