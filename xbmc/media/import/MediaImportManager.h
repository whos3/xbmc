...
public:
   ...
   */
  void RegisterImporter(const MediaImporterPtr importer);
  /*!
   ...
   */
  bool UnregisterImporter(const MediaImporterPtr importer);

  /*!
   * \brief TODO
   */
  std::vector<const MediaImporterPtr> GetImporters() const;

  /*!
   * \brief TODO
   */
  const MediaImporterPtr GetImporter(const std::string &path) const;
  ...
  * \brief TODO
  */
  const MediaImportHandlerPtr GetImportHandler(const MediaType& mediaType) const;

  /*!
  * \brief TODO
  */
  std::vector<const MediaImportHandlerPtr> GetImportHandlers() const;

  /*!
  * \brief TODO
  */
  std::vector<const MediaImportHandlerPtr> GetImportHandlers(const std::set<MediaType>& mediaTypes) const;
...
private:
  ...
  std::map<const char*, const MediaImporterPtr> m_importers;

  CCriticalSection m_importHandlersLock;
  std::map<MediaType, const MediaImportHandlerPtr> m_importHandlersMap;
  std::vector<const MediaImportHandlerPtr> m_importHandlers;
