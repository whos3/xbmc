...
{
public:
  CMediaImportChangesetTask(const CMediaImport &import, MediaImportHandlerPtr importHandler, const std::vector<CFileItemPtr> &localItems, const ChangesetItems &retrievedItems);
  ...
  virtual MediaImportTaskType GetType() const override { return MediaImportTaskType::Changeset; }
