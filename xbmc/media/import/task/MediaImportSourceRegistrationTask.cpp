...
CMediaImportSourceRegistrationTask::CMediaImportSourceRegistrationTask(const CMediaImportSource &source)
  : IMediaImportTask(CMediaImport::CreateRecursive(source.GetIdentifier(), { MediaTypeNone }, source))
{ }
...
bool CMediaImportSourceRegistrationTask::DoWork()
{
  ...
  if (CMediaImportManager::GetInstance().GetImporter(source.GetIdentifier()) == nullptr)
  {
