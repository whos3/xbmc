...
public:
   ...
   */
  bool GetImportedMedia(const MediaType &mediaType, CFileItemList& items) const;
  /*!
   ...
   */
  void AddItem(const MediaType &mediaType, const CFileItemPtr& item);
  /*!
   ...
   */
  void SetItems(const MediaType &mediaType, const std::vector<CFileItemPtr>& items);
...
protected:
  ...
  std::map<MediaType, std::vector<CFileItemPtr> > m_importedMedia;
};
