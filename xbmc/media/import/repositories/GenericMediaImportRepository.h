...
public:
  ...
  std::vector<CMediaImport> GetImportsByMediaType(const GroupedMediaTypes &mediaTypes) const override;
  std::vector<CMediaImport> GetImportsByPath(const std::string &path, bool includeSubDirectories = false) const override;
  bool GetImport(const std::string &path, const GroupedMediaTypes &mediaTypes, CMediaImport &import) const override;
  ...
  std::vector<CMediaImportSource> GetSources(const GroupedMediaTypes &mediaTypes = GroupedMediaTypes()) const override;
