...
public:
  ...
  CSeasonImportHandler* Create() const override { return new CSeasonImportHandler(m_importHandlerManager); }
  ...
  GroupedMediaTypes GetGroupedMediaTypes() const override { return { MediaTypeTvShow, MediaTypeSeason, MediaTypeEpisode }; }
...
protected:
  ...
  void RemoveImportedItem(CVideoDatabase &videodb, const CMediaImport &import, const CFileItem* item) const;
