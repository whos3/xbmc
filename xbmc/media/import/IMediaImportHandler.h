...
public:
   ...
   */
  virtual CFileItemPtr FindMatchingLocalItem(const CMediaImport &import, const CFileItem* item, const std::vector<CFileItemPtr>& localItems) const = 0;
   ...
   */
  virtual MediaImportChangesetType DetermineChangeset(const CMediaImport &import, const CFileItem* item, const CFileItemPtr& localItem) = 0;
   ...
   * \param localItem Previously imported item
   */
  virtual void PrepareImportedItem(const CMediaImport& import, CFileItem* item, const CFileItemPtr& localItem) const = 0;
