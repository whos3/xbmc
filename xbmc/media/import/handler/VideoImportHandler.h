...
public:
  ...
  virtual void SetImportedItemsEnabled(const std::string &source, bool enable);
...
protected:
  ...
  bool PrepareImport(const CMediaImport &import, CVideoDatabase &videodb);
  void PrepareItem(const CMediaImport &import, CFileItem* pItem, CVideoDatabase &videodb);
  void PrepareItem(CFileItem *updatedItem, const CFileItem *originalItem);
