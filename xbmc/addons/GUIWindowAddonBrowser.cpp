...
void CGUIWindowAddonBrowser::GetContextButtons(CFileItemPtr pItem, CContextButtons& buttons)
{
  if (pItem == NULL)
    return;
...
bool CGUIWindowAddonBrowser::OnContextButton(CFileItemPtr pItem,
