...
class COhUPnPMediaRendererConnectionManagerService : public IOhUPnPService
{
public:
  COhUPnPMediaRendererConnectionManagerService(COhUPnPRootDevice& device);
  virtual ~COhUPnPMediaRendererConnectionManagerService();
...
private:
  ...
  {
  public:
    ConnectionManager(COhUPnPMediaRendererConnectionManagerService& service, OpenHome::Net::DvDeviceStd& device);
  ...
  private:
    COhUPnPMediaRendererConnectionManagerService& m_service;
  };
