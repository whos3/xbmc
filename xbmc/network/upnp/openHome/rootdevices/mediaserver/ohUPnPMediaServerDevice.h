...
class COhUPnPContentDirectoryService;
class COhUPnPMediaServerConnectionManagerService;

class COhUPnPMediaServerDevice : public COhUPnPRootDevice
{
public:
  COhUPnPMediaServerDevice(const std::string& uuid,
...
private:
  // services
  std::unique_ptr<COhUPnPContentDirectoryService> m_contentDirectory;
  std::unique_ptr<COhUPnPMediaServerConnectionManagerService> m_connectionManager;
