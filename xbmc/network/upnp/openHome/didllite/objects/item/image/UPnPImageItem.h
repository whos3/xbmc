...
public:
  ...
  virtual CUPnPImageItem* Create() const override { return Clone(); }
  virtual CUPnPImageItem* Clone() const override { return new CUPnPImageItem(*this); }
  virtual std::string GetIdentifier() const { return "ImageItem"; }
