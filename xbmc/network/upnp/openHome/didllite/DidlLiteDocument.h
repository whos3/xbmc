...
public:
  ...
  virtual IDidlLiteElement* Create() const override { return nullptr; }
  virtual IDidlLiteElement* Clone() const override { return nullptr; }
  virtual std::string GetIdentifier() const { return "Document"; }
  ...
  bool Serialize(std::string& result, const OhUPnPRootDeviceContext& context) const;
  bool Deserialize(const std::string& data, const OhUPnPControlPointContext& context);
