...
namespace XBMCAddon
{
  namespace xbmcaddon
  {
    ...
    public:
...
#ifndef SWIG
      inline Settings(std::shared_ptr<CSettingsBase> settings, const std::string& addonId,
        ADDON::IAddonSettingsCallbackExecutor* callbackExecutor = nullptr, void* callbackData = nullptr)
        : settings(settings)
        , m_addonId(addonId)
      ...
      setBoolList(...);
#else
      void setBoolList(const char* id, const std::vector<bool>& values) throw(XBMCAddon::WrongTypeException);
#endif
      ...
      setIntList(...);
#else
      void setIntList(const char* id, const std::vector<int>& values) throw(XBMCAddon::WrongTypeException);
#endif
      ...
      setNumberList(...);
#else
      void setNumberList(const char* id, const std::vector<double>& values) throw(XBMCAddon::WrongTypeException);
#endif
      ...
      setStringList(...);
#else
      void setStringList(const char* id, const std::vector<String>& values) throw(XBMCAddon::WrongTypeException);
#endif
...
#else
      bool registerActionCallback(const String& settingId, const String& callback) throw(SettingCallbacksNotSupportedException);
#endif
...
#else
      bool registerOptionsFillerCallback(const String& settingId, const String& callback) throw(SettingCallbacksNotSupportedException);
#endif
      ...
      setIntegerOptions(...);
#else
      bool setIntegerOptions(const String& settingId,
      ...
      private:
        ...
        static void IntegerSettingOptionsFiller(std::shared_ptr<const CSetting> setting, IntegerSettingOptions& list, int& current, void* data);
        static void StringSettingOptionsFiller(std::shared_ptr<const CSetting> setting, StringSettingOptions& list, std::string& current, void* data);
