...
static constexpr int MediaImportChangesetTypeNone =
    static_cast<int>(MediaImportChangesetType::None);
static constexpr int MediaImportChangesetTypeAdded =
    static_cast<int>(MediaImportChangesetType::Added);
static constexpr int MediaImportChangesetTypeChanged =
    static_cast<int>(MediaImportChangesetType::Changed);
static constexpr int MediaImportChangesetTypeRemoved =
