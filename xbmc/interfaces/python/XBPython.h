...
typedef LockableType<std::unordered_map<std::string, XBMCAddon::xbmcmediaimport::Observer*> > MediaImporterObserverCallbackList;
...
public:
  ...
  void RegisterPythonMediaImporterObserverCallback(const std::string& importerId, XBMCAddon::xbmcmediaimport::Observer* observer);
  void UnregisterPythonMediaImporterObserverCallback(const std::string& importerId, XBMCAddon::xbmcmediaimport::Observer* observer);
