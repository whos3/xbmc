...
JSON_STATUS CAudioLibrary::GetArtists(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
...
JSON_STATUS CAudioLibrary::GetArtistDetails(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
...
JSON_STATUS CAudioLibrary::GetAlbums(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
  CMusicDatabase musicdatabase;
  if (!musicdatabase.Open())
    return InternalError;
...
JSON_STATUS CAudioLibrary::GetAlbumDetails(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
...
JSON_STATUS CAudioLibrary::GetSongs(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
  CMusicDatabase musicdatabase;
  if (!musicdatabase.Open())
    return InternalError;
...
JSON_STATUS CAudioLibrary::GetSongDetails(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
...
JSON_STATUS CAudioLibrary::GetRecentlyAddedAlbums(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
  CMusicDatabase musicdatabase;
  if (!musicdatabase.Open())
    return InternalError;
...
JSON_STATUS CAudioLibrary::GetRecentlyAddedSongs(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
  CMusicDatabase musicdatabase;
  if (!musicdatabase.Open())
    return InternalError;
...
JSON_STATUS CAudioLibrary::GetGenres(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
  CMusicDatabase musicdatabase;
  if (!musicdatabase.Open())
    return InternalError;
...
JSON_STATUS CAudioLibrary::Scan(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
  g_application.getApplicationMessenger().ExecBuiltIn("updatelibrary(music)");
  return ACK;
}

JSON_STATUS CAudioLibrary::Export(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
  CStdString cmd;
...
JSON_STATUS CAudioLibrary::Clean(const CStdString &method, ITransportLayer *transport, IInterfaceClient *client, const CVariant &parameterObject, CVariant &result)
{
