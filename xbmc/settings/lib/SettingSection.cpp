...
Logger CSettingGroup::s_logger = CLog::Get("CSettingGroup");
...
Logger CSettingCategory::s_logger = CLog::Get("CSettingCategory");
...
Logger CSettingSection::s_logger = CLog::Get("CSettingSection");
