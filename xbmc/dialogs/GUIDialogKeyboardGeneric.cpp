...
void CGUIDialogKeyboardGeneric::OnInitWindow()
{
  ...
  data["value"] = GetText();
  ANNOUNCEMENT::CAnnouncementManager::Announce(ANNOUNCEMENT::AnnouncementFlagInput, "xbmc", "OnInputRequested", data);
}
...
void CGUIDialogKeyboardGeneric::OnDeinitWindow(int nextWindowID)
{
  ...
  ANNOUNCEMENT::CAnnouncementManager::Announce(ANNOUNCEMENT::AnnouncementFlagInput, "xbmc", "OnInputFinished");
}
