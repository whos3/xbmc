...
#define VIDEODB_DETAILS_MOVIE_FILEID            VIDEODB_MAX_COLUMNS + 11
...
#define VIDEODB_DETAILS_EPISODE_FILEID          VIDEODB_MAX_COLUMNS + 15
...
#define VIDEODB_DETAILS_MUSICVIDEO_FILEID       VIDEODB_MAX_COLUMNS + 9
